...
exports.createExperienceRouter = createExperienceRouter;
const express_1 = require("express");
const ExperienceRepository_1 = require("../core/ExperienceRepository");
// 创建路由函数，支持传入自定义 repository（用于测试）
function createExperienceRouter(repo = ExperienceRepository_1.experienceRepo) {
...
// 默认导出使用单例实例的路由
exports.default = createExperienceRouter();
