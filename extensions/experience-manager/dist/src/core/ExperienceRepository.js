...
exports.experienceRepo = exports.ExperienceRepository = void 0;
...
class ExperienceRepository {
    ...
    create(record) {
        ...
        MemoryService_1.memoryService.storeExperience(newRecord).catch(e => {
    ...
    search(keyword) {
        ...
        return this.data.records.filter(r => r.title.toLowerCase().includes(lower) ||
     ...
     * 使用向量相似度检索相关经验
     */
    async semanticSearch(keyword, limit = 10) {
        try {
            const results = await MemoryService_1.memoryService.searchExperiences(keyword, limit);
            // 将检索结果映射回经验记录
            const records = [];
...
// 导出单例实例
exports.experienceRepo = new ExperienceRepository();
