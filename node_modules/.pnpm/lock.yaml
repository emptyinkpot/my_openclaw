...
importers:
  ...
  .:
    dependencies:
      ...
      '@langchain/langgraph':
        specifier: ^1.2.2
        version: 1.2.3(@langchain/core@1.1.34)(zod@4.3.6)
      better-sqlite3:
        specifier: ^12.8.0
        version: 12.8.0
      express:
  ...
  extensions/feishu-openclaw-plugin:
    dependencies:
...
packages:
  ...
  /@langchain/langgraph-checkpoint@1.0.1(@langchain/core@1.1.34):
  ...
  /@langchain/langgraph-sdk@1.7.4(@langchain/core@1.1.34):
  ...
  /@langchain/langgraph@1.2.3(@langchain/core@1.1.34)(zod@4.3.6):
